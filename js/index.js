    ...
    .then((products) => {
      ...
      products.forEach((product) => {
        ...
        prodsCards += `
                ...
                <div class="prod col me-3" data-prod-id="${
                  product.id
                    ...
                    <div class="product-item mb-4 d-flex flex-column">
                        <div class="prod-info d-flex flex-column mb-2 col-12">
                            ...
                            <a class="prod-title px-2 mt-3" style="word-break: break-all" href="./../docs/product-info.html?prod_id=${
                              product.id
                            }"
                                >${product.title}</a
                            >
...
`;
      ...
      document.querySelectorAll("p.view").forEach((p) => {
        p.addEventListener("click", function () {
          ...
          console.log(product);
          let prodImage = product
            .find(".image-container")[0]
            .getAttribute("data-prod-image");
