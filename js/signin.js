...
$("body").on("submit", "#signinForm", function (e) {
    ...
    if (emailValid === false) {
        e.preventDefault();
        // console.log(        document.getElementById("signin-msg").value)
        // document.getElementById("signin-msg").innerHTML = "jjj";
        ...
        e.preventDefault();
        document.querySelector('[id="signin-msg"]').innerHTML= `<div class="col-12 fw-bold mt-1 p-1 rounded-0" style="color: red">Password Minimum eight characters, at least one uppercase letter, one lowercase letter, one number and one special character</div>`;
    } else {
