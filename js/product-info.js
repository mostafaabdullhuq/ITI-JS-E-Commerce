        ...
        prod = `
                <div class="contain my-4"> 
                    ...
                    <div class="d-flex justify-content-center m-4">
                        <span class="prod-price h5 me-5 fw-bold">$${
                        product.price
                        }</span>
                ...
                <div class="prod-qty d-flex justify-content-center">
                        <i class="prod-qty-remove cell fs-4 fa-solid fa-minus border border-2 p-1" data-prod-id="${
                        product.id
                        }"></i>
                        <input type="text" class="prod-qty-value text-center fw-bold fs-4 w-25" data-prod-id="${
                        product.id
                        }" value="1"/>
                        <i class="prod-qty-add cell fs-4 fa-solid fa-plus border border-2 p-1" data-prod-id="${
                        product.id
                        }"></i>
                        <a class="button btn ms-3 text-center p-2" href="./../docs/cart.html?product-id=${product.id}" >Add to cart</a>
                </div>
            `;
